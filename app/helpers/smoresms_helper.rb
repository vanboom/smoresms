module SmoreSMS
  module SmoreSMSHelper
    ...
    def carrier_collection
      s = SmoreSMS::SMS.new
      s.carriers.sort.collect{ |carrier| [carrier[1]["name"], carrier[0]] }
    end
    ...
    def carrier_select(name = :sms_carrier, phrase = "Select a Carrier", selected = nil, include_blank = true)
